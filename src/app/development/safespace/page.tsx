...
import AiReport from "@/images/development/safespace/ai-report.webp";
      ...
      <section className="mx-auto flex max-w-7xl flex-col px-5">
          ...
          secondaryText={
            <>
              <p>
                ...
                work environments, intimidating reporting processes, and a lack
                of information about job site safety — and the data make this
                reality undeniable. According to a{" "}
                <ExternalLink
                  fontWeight="medium"
                ...
                throughout their careers (YWCA Halifax, 2024).
              </p>
              <p>
                SafeSpace addresses these challenges by providing preventative
                insights, AI-assisted support to reduce reporting stress, and a
                desktop web platform that turns fragmented reports into
        ...
        >
          ...
          >
            ...
            <PhotoView>
              <p className="mb-3">
                The platform consists of three components: a mobile client, a
                serverless AI layer, and a web analytics interface. The mobile
                app allows users to generate AI-assisted reports, submit
                incidents, and browse nearby posts, while the web interface
                aggregates anonymized data to provide regional safety insights.
              </p>
              <Image
                src={Architecture}
          ...
          <motion.section
            ...
            transition={{ duration: 1, ease: "easeOut" }} // Animation settings
            viewport={{ once: true, amount: 0.02 }} // Trigger animation when 2% in view, only once
            className="mb-7 md:mb-15"
          >
            <BarredHeading text="AI Report Generation Pipeline" />
            <div className="mb-35 flex flex-col md:mt-6 md:mb-40 md:flex-row md:gap-13">
              ...
              <div className="order-first mt-2 mb-5 space-y-2 text-base leading-relaxed md:order-0 md:mt-0 md:w-2/3 md:text-lg">
                <p>
                  ...
                  where a{" "}
                  <span className="font-semibold">
                    centrally managed prompt
                  </span>{" "}
                  processes the transcript to generate a structured report. This
                  separation keeps the AI processing pipeline modular and allows
                  prompt logic to be maintained on the backend.
                </p>
                <p>
                  During development, API keys were managed using{" "}
                  <span className="text-primary font-semibold">
                    environment variables (.env)
                  </span>{" "}
                  to avoid hardcoding{" "}
                  <span className="font-semibold">sensitive credentials</span>.
                </p>
              </div>
            </div>
            <PhotoView>
              <Image
                src={AiReport}
                alt="AI Report Generation Pipeline"
                placeholder="blur"
                className="cursor-pointer rounded-lg shadow-lg md:w-[70vw]"
              ></Image>
            </PhotoView>
        ...
        >
          ...
          >
            ...
            <p className="mt-2 mb-5 text-base leading-relaxed md:w-1/2 md:text-lg">
              ...
              was conducted after the mid-fidelity prototype to assess the
              usability of core flows, including incident reporting, browsing
              public posts, and viewing nearby incidents. Key pain points
              included{" "}
              <span className="font-semibold">
                unclear homepage messaging, confusion around the “posts” label,
                and a lack of clarity around the primary recording action.
              </span>
            </p>
